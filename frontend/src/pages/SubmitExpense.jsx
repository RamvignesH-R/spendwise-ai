...
import { UploadCloud, CheckCircle, ShieldAlert, Sparkles } from 'lucide-react';

export default function SubmitExpense() {
  const [formData, setFormData] = useState({ title: '', amount: '', category: 'Travel', date: '', justification: '' });
      ...
      <form onSubmit={handleSubmit} className="glass-card p-8">
        ...
        {step === 2 && (
          <div className="space-y-6 animate-in slide-in-from-right">
            ...
            <div className="border-2 border-dashed border-gray-600 rounded-xl p-8 text-center bg-black/30 hover:bg-black/40 hover:border-secondary transition-all cursor-pointer group">
              <UploadCloud size={32} className="mx-auto text-gray-400 group-hover:text-secondary group-hover:animate-bounce mb-3" />
              <p className="text-sm text-gray-300">Drag & Drop Receipt Image Here</p>
